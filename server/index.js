...
const CONNECTION_URL = 'mongodb+srv://socialnetwork:socialnetwork@cluster0.csvum.mongodb.net/myFirstDatabase?retryWrites=true&w=majority';

mongoose.connect(CONNECTION_URL).then(()=>{
    console.log(`SERVER connect DATABASE through: ${PORT}`)
})
//'mongodb+srv://socialnetwork:socialnetwork@cluster0.csvum.mongodb.net/myFirstDatabase?retryWrites=true&w=majority'